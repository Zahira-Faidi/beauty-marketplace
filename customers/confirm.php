...
<polygon class="st0" points="0.1,260.3 167.4,341 180.4,380.3 "/>
            ...
            <h1 class="brand brand-name navbar-left"><div class="navbar-left"></div>soins de sois</h1>
        </div>
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="confirm.php?update_id=<?php echo $order_id;  ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <div class="text-center"><!-- text-center Begin -->
                           ...
                           <button class="btn btn-danger  btn-lg" name="confirm_payment"><!-- tn btn-danger  btn-lg Begin -->
                               
                               <i class="glyphicon glyphicon-thumbs-up	
"></i> Confirm Payment
                               
                           </button><!-- tn btn-danger  btn-lg Finish -->
